# Resolução do problema do caixeiro viajante com AG
# Alunos: Caio Garcia, Isabel Lopes, Leonardo Curty

# Verifique se todas as bibliotecas estão instaladas na sua máquina
import numpy as np 
import random
import operator
import pandas as pd
